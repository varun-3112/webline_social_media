...
public class JwtService {
	...
	/*
	 * //requirement : public static final long JWT_TOKEN_VALIDITY = 5 * 60 * 60;
	 * 
	 * // public static final long JWT_TOKEN_VALIDITY = 60; private String secret =
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        return Jwts.builder().setClaims(claims).setSubject(subject).setIssuedAt(new Date(System.currentTimeMillis()))
                .setExpiration(new Date(System.currentTimeMillis() + Integer.parseInt(env.getProperty("JWT_TOKEN_VALIDITY_MINUTES")) * 60 * 1000))
